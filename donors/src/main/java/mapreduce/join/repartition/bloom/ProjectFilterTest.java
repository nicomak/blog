...
import mapreduce.join.repartition.bloom.RepartitionJoinBloomFiltered.DonationsMapper;
...
public class ProjectFilterTest {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    job.getConfiguration().set(DonationsMapper.DONATION_FILTER_FILE, donationsBloomFilter.getName());
